...
public class HelpCommand : ICommand
{
    ...
    public HelpCommand(ILogger<HelpCommand> logger, IConsoleService console, IEnumerable<ICommand> commands)
    {
        _logger = logger;
        _console = console;
        _commands = commands;
    ...
    public Task<int> ExecuteAsync(string[] args)
    {
        ...
        foreach (var command in _commands.Where(c => c.Name != "help"))
        {
            commandTable.AddRow("", $"[yellow]{command.Name}[/]", command.Description);
        }
